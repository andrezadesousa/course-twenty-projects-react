...
const Calculadora = () => {
  const [currentValue, setCurrentValue] = useState("0"); // valor atual
  const [pendingOperation, setPendingOperation] = useState(null); //operação pendente
...
// map = girar vários itens através de uma repetição
